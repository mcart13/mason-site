...
export function ProjectCard({
  ...
  return (
    ...
    >
      <a className="group block py-8 border-t border-border" href={href}>
        <div className="flex flex-col md:flex-row md:items-baseline justify-between gap-4">
          <div className="flex-1">
            <h3 className="text-xl md:text-2xl font-medium group-hover:text-muted-foreground transition-colors">
              {title}
            </h3>
